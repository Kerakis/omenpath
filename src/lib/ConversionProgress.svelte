...
<div class="rounded-lg bg-white p-6 shadow-lg">
	<h2 class="mb-4 text-2xl font-semibold text-gray-800">Converting...</h2>
	...
	<div class="space-y-4">
		<div>
			...
			<div class="h-2 w-full rounded-full bg-gray-200">
				<div class="progress-bar h-2 rounded-full bg-blue-600" style="width: {progress}%"></div>
			</div>
		</div>

		<div class="flex items-center text-sm text-gray-500">
			<svg
				class="mr-3 -ml-1 h-4 w-4 animate-spin text-blue-600"
